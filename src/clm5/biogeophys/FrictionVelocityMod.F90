...
#include "shr_assert.h"
  ...
  type, public :: frictionvel_type
     ...
     real(r8), pointer, public :: raw1_patch       (:)   ! patch moisture resistance (s/m)
#endif
