...
2. **Modify the documentation or code**. Proposed changes must be linked to an open issue (see #1) and go through the standard [Github pull request] process, which is explained below in brief:
    ...
    3. Make changes on your branch, [commit], and then [`git push` your changes]. Keep doing this until you're satisfied with your changes and ready to share your ideas/results.
    ...
    5. Mark your PR as "Ready" to start the review process. Then try to resolve the comments raised by the maintainers.
