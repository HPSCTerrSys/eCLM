...
if(COMPILER STREQUAL "GNU")
    ...
    set(CMAKE_Fortran_FLAGS "-std=f2018 -fconvert=big-endian -ffree-line-length-none -ffixed-line-length-none -ffree-form -fopenmp -fallow-argument-mismatch")
...
elseif(COMPILER STREQUAL "Intel" OR COMPILER STREQUAL "IntelLLVM")
    ...
    set(CMAKE_Fortran_FLAGS "-stand f18 -free -qno-opt-dynamic-align -ftz -traceback -convert big_endian -assume byterecl -assume realloc_lhs -fp-model source -qopenmp")
    if(USE_PDAF)
